...
from .infer import inference, aug_inference
from .metrics import (
...
def evaluate(model,
    ...
    Args:
        ...
        is_auc_roc(bool, optional): whether add auc_roc metric. Default: True.
    """
    model.eval()
    ...
    if print_detail:
        ...
        infor = infor + auc_infor if is_auc_roc else infor
        logger.info(infor)
    if is_auc_roc:
